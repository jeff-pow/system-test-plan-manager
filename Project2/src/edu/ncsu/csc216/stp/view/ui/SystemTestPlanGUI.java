	...
	private class TestPlansPanel extends JPanel implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == comboTestPlans) {
				...
				try {
					String testPlanName = JOptionPane.showInputDialog(this, "Test Plan Name?", "Create New Test Plan", JOptionPane.QUESTION_MESSAGE);
		...
		public void updateLists() {
			if (manager == null) {
				...
				for (String testPlanName2 : testPlanNames) {
					comboTestPlans.addItem(testPlanName2);
				}
